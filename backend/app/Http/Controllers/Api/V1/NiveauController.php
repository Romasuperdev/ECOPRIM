 ...
 *
 * Pas de cycle : une école primaire n'en a qu'un. La colonne `CodeCycle` existe toujours
 * dans T_NIVEAU et ses valeurs sont préservées — NEXORA ne la lit ni ne l'écrit plus.
 */
