...
@section('titre', 'Attestation de fréquentation')

@section('contenu')
    <p>
        Le Directeur de l'établissement {{ $etablissement ?? 'NEXORA École Primaire' }}, soussigné, atteste que :
    </p>
    ...
    <p class="section">
        a fréquenté notre établissement durant l'année scolaire <strong>{{ $eleve->annee ?? $annee }}</strong>,
        en classe de <strong>{{ $classe ?? $eleve->classe_code ?: 'non renseignée' }}</strong>.
    </p>
